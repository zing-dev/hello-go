...
// protoc --go_out=. pb/user_message.proto
//
// Windows
...
// protoc --js_out=import_style=commonjs,binary:./browser pb/user_message.proto
	...
	namespace: neffos.Events{
		...
		"chat": func(c *neffos.NSConn, msg neffos.Message) error {
			...
			if !c.Conn.IsClient() {
				...
				fmt.Printf("[%s] at %s says: %s\n", userMsg.Username, userMsg.At, userMsg.Text)
			}
...
func startClient() {
	...
	for {
		...
		userMsg.At = time.Now().Format("2006/01/02 15:04:05")
